...
//    final static String twitter_auth_token =
//            "707994985115705344-PCIbHLJFUgf2EwRSBC9byIwbkJRKCL4";
//    final static String twitter_consumer_secret =
//            "tKK8SeJLPC8T6ylmaI2sl8TuJwBKctG9KgONq88mSaqjCf99Sq&h4yg4Cfp2bE1FjHqzMlZ23OjpzKWZwowmLAg1JKemHzt4";
...
//
//                    "GET&"+URLEncoder.encode("https://api.twitter.com/1.1/statuses/user_timeline.json",
//                            "UTF-8")+"&count%3D1%26include_rts%3Dtrue%26";
//            for(int i = 0; i < data.length; i++) {
//                // ignore the empty oauth_signature field
//                if(i != 2) {
//                    signature_base_string +=
//                            URLEncoder.encode(data[i][0], "UTF-8") + "%3D" +
//                                    URLEncoder.encode(data[i][1],
//                                            "UTF-8") + "%26";
//                }
//            }
...
//                    SecretKeySpec(twitter_consumer_secret.getBytes(), mac.getAlgorithm());
//            mac.init(secret);
...
//                    URLEncoder.encode(twitter_consumer_key, "UTF-8");
//            String encodedConsumerSecret =
//                    URLEncoder.encode(twitter_consumer_secret, "UTF-8");
//
